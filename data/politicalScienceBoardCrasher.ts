...
export const POLITICAL_SCIENCE_BOARD_CRASHER = {
  ...
  chapter1: {
    ...
    mustKnowConcepts: [
      { term: 'Cold War', definition: 'Ideological, political, and economic rivalry between USA and USSR (1947-1991) without direct military confrontation.' },
      { term: 'Bipolarity', definition: 'International system with two superpowers (USA and USSR) dominating world politics.' },
      { term: 'Unipolarity', definition: 'International system dominated by single superpower (USA) after 1991.' },
      { term: 'Multipolarity', definition: 'International system with multiple power centers (USA, China, India, EU, Russia).' },
      { term: 'Glasnost', definition: 'Policy of openness and transparency introduced by Gorbachev in USSR.' },
      { term: 'Perestroika', definition: 'Economic restructuring policy of Gorbachev to modernize Soviet economy.' },
      { term: 'New World Order', definition: 'Post-Cold War international system emphasizing cooperation, democracy, and US leadership.' },
      { term: 'Soft Power', definition: 'Ability to influence through culture, values, and diplomacy rather than military force.' },
      { term: 'Hard Power', definition: 'Influence through military strength and economic coercion.' },
      { term: 'End of History', definition: 'Fukuyama\'s thesis that liberal democracy is the final form of government.' },
      { term: 'Clash of Civilizations', definition: 'Huntington\'s theory that future conflicts will be between civilizations/cultures.' },
    ],
    ...
    pyqMCQs: [
      // Feb 2024
      { q: 'USSR disintegrated in:', options: ['1989', '1990', '1991', '1992'], correct: 2, year: 2024 },
      { q: 'Berlin Wall fell in:', options: ['1987', '1989', '1991', '1993'], correct: 1, year: 2024 },
      // Feb 2023
      { q: 'Cold War ended with:', options: ['German unification', 'USSR collapse', 'Vietnam War', 'Gulf War'], correct: 1, year: 2023 },
      { q: 'Who introduced Glasnost?', options: ['Stalin', 'Brezhnev', 'Gorbachev', 'Yeltsin'], correct: 2, year: 2023 },
      // Feb 2022
      { q: 'New World Order was announced by:', options: ['Clinton', 'Bush Sr.', 'Reagan', 'Obama'], correct: 1, year: 2022 },
      { q: '9/11 attacks occurred in:', options: ['1999', '2000', '2001', '2002'], correct: 2, year: 2022 },
      // Feb 2021
      { q: 'NATO is a _____ alliance.', options: ['Economic', 'Military', 'Cultural', 'Political'], correct: 1, year: 2021 },
      { q: 'BRICS includes:', options: ['Japan', 'Germany', 'South Africa', 'USA'], correct: 2, year: 2021 },
      // Feb 2020
      { q: 'First Gulf War was in:', options: ['1989', '1991', '2001', '2003'], correct: 1, year: 2020 },
      { q: 'End of History thesis by:', options: ['Huntington', 'Fukuyama', 'Marx', 'Weber'], correct: 1, year: 2020 },
      // Feb 2019
      { q: 'Maastricht Treaty formed:', options: ['NATO', 'UN', 'EU', 'SAARC'], correct: 2, year: 2019 },
      { q: 'Warsaw Pact was led by:', options: ['USA', 'UK', 'USSR', 'France'], correct: 2, year: 2019 },
    ],
...
Multipolar world offers India unprecedented opportunities for strategic autonomy and global influence, but requires skilful diplomacy to navigate complex relationships.`
  ...
  chapter2: {
    ...
    mustKnowConcepts: [
      { term: 'Globalisation', definition: 'Integration of national economies and societies through trade, investment, technology, and cultural exchange.' },
      { term: 'Liberalisation', definition: 'Reducing government restrictions on economy, trade, and business.' },
      { term: 'Privatisation', definition: 'Transfer of ownership from public (government) sector to private sector.' },
      { term: 'MNC/TNC', definition: 'Multinational/Transnational Corporation - companies operating in multiple countries.' },
      { term: 'WTO', definition: 'World Trade Organization - regulates international trade, formed 1995.' },
      { term: 'Glocalisation', definition: 'Adapting global products to local tastes and preferences.' },
      { term: 'McDonaldization', definition: 'Spread of Western fast-food culture and standardization globally.' },
      { term: 'Outsourcing/BPO', definition: 'Contracting business processes to external (often foreign) providers.' },
      { term: 'FDI', definition: 'Foreign Direct Investment - investment from foreign entities.' },
      { term: 'Digital Divide', definition: 'Gap between those with and without access to internet/technology.' },
      { term: 'Brain Drain', definition: 'Migration of skilled professionals from developing to developed countries.' },
    ],

    pyqMCQs: [
      { q: 'Globalisation gained momentum after:', options: ['1945', '1991', '2001', '1971'], correct: 1, year: 2024 },
      { q: 'WTO was established in:', options: ['1991', '1995', '2000', '1948'], correct: 1, year: 2024 },
      { q: 'LPG stands for:', options: ['Liquefied Petroleum Gas', 'Liberalisation Privatisation Globalisation', 'Local Provincial Government', 'None'], correct: 1, year: 2023 },
      { q: 'Glocalisation means:', options: ['Only Global', 'Only Local', 'Global + Local', 'None'], correct: 2, year: 2023 },
      { q: 'MNC stands for:', options: ['Multinational Corporation', 'Municipal National Council', 'Many Nations Club', 'None'], correct: 0, year: 2022 },
      { q: 'Which is NOT a feature of Globalisation?', options: ['Free trade', 'Integration', 'Nationalism', 'Interdependence'], correct: 2, year: 2022 },
      { q: 'BPO stands for:', options: ['Business Process Outsourcing', 'Bank Public Office', 'Business Public Organization', 'None'], correct: 0, year: 2021 },
      { q: '1991 reforms in India were led by:', options: ['Vajpayee', 'Manmohan Singh', 'Indira Gandhi', 'Modi'], correct: 1, year: 2021 },
      { q: 'FDI means:', options: ['Foreign Direct Investment', 'Free Distribution of Income', 'Foreign Development Index', 'None'], correct: 0, year: 2020 },
      { q: 'Which grew most in India due to Globalisation?', options: ['Agriculture', 'Service/IT sector', 'Mining', 'Fishing'], correct: 1, year: 2020 },
    ],
...
Globalisation has been a double-edged sword for India. While it brought economic growth and opportunities, it also created challenges of inequality and sustainability that need addressing through inclusive policies.`
  ...
  chapter3: {
    ...
    mustKnowConcepts: [
      { term: 'Human Rights', definition: 'Universal rights inherent to all human beings regardless of nationality, sex, religion, etc.' },
      { term: 'UDHR', definition: 'Universal Declaration of Human Rights - adopted by UN in 1948.' },
      { term: 'Refugees', definition: 'People forced to flee their country due to persecution, war, or violence.' },
      { term: 'UNHCR', definition: 'United Nations High Commissioner for Refugees - UN agency for refugees.' },
      { term: 'Migration', definition: 'Movement of people from one place to another for various reasons.' },
      { term: 'Terrorism', definition: 'Use of violence against civilians for political, religious, or ideological goals.' },
      { term: 'Climate Change', definition: 'Long-term change in global temperatures and weather patterns.' },
      { term: 'Humanitarian Intervention', definition: 'Use of force to protect human rights in another country.' },
    ],

    pyqMCQs: [
      { q: 'UDHR was adopted in:', options: ['1945', '1948', '1950', '1991'], correct: 1, year: 2024 },
      { q: 'Human Rights Day is on:', options: ['Oct 24', 'Dec 10', 'Jan 26', 'Aug 15'], correct: 1, year: 2023 },
      { q: 'UNHCR deals with:', options: ['Trade', 'Refugees', 'Health', 'Children'], correct: 1, year: 2022 },
      { q: 'Paris Agreement is related to:', options: ['Trade', 'Human Rights', 'Climate Change', 'War'], correct: 2, year: 2021 },
      { q: 'Terrorism is a _____ threat.', options: ['Local', 'National', 'Global', 'None'], correct: 2, year: 2020 },
    ],
...
5. **Solutions**: UNHCR assistance, resettlement, addressing root causes`
  ...
  chapter4: {
    ...
    mustKnowConcepts: [
      { term: 'Communalism', definition: 'Using religion for political purposes, leading to inter-religious conflicts.' },
      { term: 'Regionalism', definition: 'Strong attachment to one\'s region over national identity.' },
      { term: 'Casteism', definition: 'Discrimination based on caste; affects politics and society.' },
      { term: 'Terrorism', definition: 'Use of violence for political aims; internal (Naxalism) and cross-border.' },
      { term: 'Naxalism/Left-Wing Extremism', definition: 'Armed communist movement in tribal areas of central-eastern India.' },
      { term: 'National Integration', definition: 'Unity of diverse groups into a single national identity.' },
      { term: 'Secularism', definition: 'State neutrality in religious matters; equal treatment of all religions.' },
    ],

    pyqMCQs: [
      { q: 'Communalism means:', options: ['Unity', 'Using religion for politics', 'Regional loyalty', 'Caste pride'], correct: 1, year: 2024 },
      { q: 'Naxalism started in:', options: ['1947', '1967', '1991', '2001'], correct: 1, year: 2023 },
      { q: 'National Integration means:', options: ['Economic growth', 'Unity in diversity', 'Military strength', 'None'], correct: 1, year: 2022 },
      { q: 'Secularism means:', options: ['Against religion', 'State neutrality in religion', 'Promoting one religion', 'None'], correct: 1, year: 2021 },
      { q: 'Regionalism is based on:', options: ['Religion', 'Caste', 'Region/Language', 'Class'], correct: 2, year: 2020 },
    ],
...
India's unity depends on addressing these challenges through inclusive development, good governance, and promoting national consciousness while respecting diversity.`
  ...
  chapter5: {
    ...
    mustKnowConcepts: [
      { term: 'Good Governance', definition: 'Transparent, accountable, participatory, and responsive administration.' },
      { term: 'E-Governance', definition: 'Use of ICT (Information and Communication Technology) for government services.' },
      { term: 'RTI', definition: 'Right to Information Act, 2005 - citizens can request government information.' },
      { term: 'Lokpal', definition: 'Anti-corruption ombudsman at central level (Lokpal and Lokayuktas Act, 2013).' },
      { term: 'Lokayukta', definition: 'Anti-corruption ombudsman at state level.' },
      { term: 'Citizen\'s Charter', definition: 'Document stating standards of service delivery to citizens.' },
      { term: 'Transparency', definition: 'Openness in government functioning and decision-making.' },
      { term: 'Accountability', definition: 'Government being answerable to citizens for its actions.' },
    ],

    pyqMCQs: [
      { q: 'RTI Act was passed in:', options: ['2000', '2005', '2010', '2015'], correct: 1, year: 2024 },
      { q: 'Lokpal is for:', options: ['State', 'Centre', 'Panchayat', 'All'], correct: 1, year: 2023 },
      { q: 'E-Governance uses:', options: ['Letters', 'ICT/Technology', 'Telegraph', 'None'], correct: 1, year: 2022 },
      { q: 'Good Governance includes:', options: ['Secrecy', 'Transparency', 'Authoritarianism', 'None'], correct: 1, year: 2021 },
      { q: 'Citizen\'s Charter is about:', options: ['Service standards', 'Military', 'Trade', 'None'], correct: 0, year: 2020 },
    ],
...
India has made significant progress in governance reforms. However, effective implementation and citizen awareness are key to achieving good governance goals.`
  ...
  chapter6: {
    ...
    mustKnowConcepts: [
      { term: 'Foreign Policy', definition: 'Strategy of a country in dealing with other nations to protect its interests.' },
      { term: 'Non-Alignment', definition: 'Not joining any military bloc; independent foreign policy. India\'s policy during Cold War.' },
      { term: 'Panchsheel', definition: 'Five Principles of Peaceful Coexistence (1954, India-China agreement).' },
      { term: 'NAM', definition: 'Non-Aligned Movement - group of countries not aligned with superpowers.' },
      { term: 'SAARC', definition: 'South Asian Association for Regional Cooperation (1985).' },
      { term: 'BRICS', definition: 'Brazil, Russia, India, China, South Africa - emerging economies grouping.' },
      { term: 'G20', definition: 'Group of 20 major economies; India hosted 2023 summit.' },
      { term: 'SCO', definition: 'Shanghai Cooperation Organisation - Eurasian political/security alliance.' },
      { term: 'Quad', definition: 'Quadrilateral Security Dialogue - India, USA, Japan, Australia.' },
      { term: 'Act East Policy', definition: 'India\'s policy to engage with Southeast Asia and East Asia (since 2014).' },
    ],

    pyqMCQs: [
      { q: 'Panchsheel was signed in:', options: ['1947', '1950', '1954', '1962'], correct: 2, year: 2024 },
      { q: 'SAARC headquarters is in:', options: ['Delhi', 'Colombo', 'Kathmandu', 'Dhaka'], correct: 2, year: 2024 },
      { q: 'G20 Summit 2023 was hosted by:', options: ['USA', 'China', 'India', 'Brazil'], correct: 2, year: 2024 },
      { q: 'NAM was founded in:', options: ['1955', '1961', '1971', '1991'], correct: 1, year: 2023 },
      { q: 'India-China war occurred in:', options: ['1947', '1962', '1971', '1999'], correct: 1, year: 2023 },
      { q: 'India-Pakistan wars:', options: ['1947, 1965, 1971', '1947, 1962', '1947 only', 'None'], correct: 0, year: 2022 },
      { q: 'Kargil conflict was in:', options: ['1998', '1999', '2000', '2001'], correct: 1, year: 2022 },
      { q: 'BRICS summit 2023 added new members from:', options: ['Europe', 'Middle East/Africa', 'Americas', 'None'], correct: 1, year: 2021 },
      { q: 'Act East Policy replaced:', options: ['Act West', 'Look East', 'Act North', 'None'], correct: 1, year: 2021 },
      { q: 'Quad includes:', options: ['India-China-Japan-USA', 'India-USA-Japan-Australia', 'India-Russia-USA', 'None'], correct: 1, year: 2020 },
    ],
