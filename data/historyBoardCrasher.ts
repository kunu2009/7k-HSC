export const HISTORY_BOARD_CRASHER = {
  ...
  chapter1: {
    ...
    mustKnowConcepts: [
      {
        term: "Renaissance",
        definition: "Rebirth of art and learning in Europe (14th-16th century)."
      },
      {
        term: "Crusades",
        definition: "Religious wars fought by Christians to regain Jerusalem from Islamic rule."
      },
      {
        term: "Humanism",
        definition: "Intellectual movement focusing on human potential and achievements."
      },
      {
        term: "Empiricism",
        definition: "Theory that all knowledge is derived from sense-experience (observation/experiment)."
      },
      {
        term: "Industrial Revolution",
        definition: "Transition to new manufacturing processes in Europe/US (1760-1840)."
      }
    ],
  ...
  chapter2: {
    ...
    shortcodes: [
      {
        ...
        breakdown: "Capital • Raw materials • Industrial Revolution • Markets • Expansion"
      }
    ],
    ...
    mustKnowConcepts: [
      {
        term: "Colonialism",
        definition: "Practice of acquiring full or partial political control over another country."
      },
      {
        term: "Imperialism",
        definition: "Policy of extending a country's power and influence through colonization."
      },
      {
        term: "Scramble for Africa",
        definition: "Invasion, occupation, and colonization of African territory by European powers (1881-1914)."
      }
    ],
    ...
    pyqMCQs: [
      {
        ...
        options: ["Renaissance", "Industrial Revolution", "Reformation", "French Revolution"],
        correct: 1,
        year: 2023
      },
      {
      ...
      },
      {
        ...
        options: ["Partition of India", "Partition of Africa", "Partition of China", "Partition of America"],
        correct: 1,
        year: 2024
      }
    ],
  ...
  mostImportant2026: {
    ...
    identifyConcepts: [
      ...
      },
      {
        ...
        explanation: "The Berlin Conference (1884-85) regulated European colonization and trade in Africa, leading to the partition of the continent among European powers."
      },
      {
        q: "Raja Ram Mohan Roy established an organization to reform Hindu society.",
        concept: "Brahmo Samaj",
        explanation: "Established in 1828, Brahmo Samaj was a monotheistic sect of Hinduism. It crusaded against polytheism, idol worship, and social evils like Sati."
      },
      {
        ...
        explanation: "After the Revolt of 1857, the British Crown assumed direct control of India via the Government of India Act 1858, ending Company rule."
      },
      {
        q: "Subhash Chandra Bose formed an army to fight against the British.",
        concept: "Azad Hind Fauj (Indian National Army)",
        explanation: "The INA was an armed force formed by Indian nationalists in 1942 in Southeast Asia to secure Indian independence with Japanese support."
      },
      {
        ...
        explanation: "The process by which Sardar Patel used diplomacy and pressure to persuade rulers of princely states to accede to the Dominion of India."
      },
      {
        q: "Dr. Babasaheb Ambedkar led a satyagraha at Mahad.",
        concept: "Mahad Satyagraha / Dalit Rights Movement",
        explanation: "A satyagraha led by Dr. Ambedkar in 1927 to allow untouchables to use water in a public tank (Chavdar Tale) in Mahad, Maharashtra."
      },
      {
  ...
  lastMinutePoints: {
    ...
    importantPersons: [
      ...
      "Mahatma Phule - Education & Dalit Rights",
      "Swami Vivekananda - Ramakrishna Mission",
      "Lokmanya Tilak - 'Swaraj is my birthright'",
      "Mahatma Gandhi - Ahimsa & Satyagraha",
      "Dr. B.R. Ambedkar - Architect of Constitution",
      "Sardar Patel - Iron Man of India"
    ],
    examTips: [
      "Draw timelines for historical events.",
      "Practice map pointing (2 marks).",
      "Remember key dates and years.",
      "Use mnemonics for long answers.",
      "Read questions carefully - 'Identify' vs 'Explain'."
    ]
  }
};
