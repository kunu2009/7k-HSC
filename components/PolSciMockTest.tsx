  ...
  sections: [
    {
      ...
      questions: [
        ...
        {
          id: "q1a2",
          question: "Until the coming in of a foreign channel, ___ was the only TV broadcaster in India.",
        ...
        {
          id: "q1a3",
          question: "As per the Census Report 2011, the female literacy rate is ___.",
        ...
        {
          id: "q1a4",
          question: "Naxalism began as a protest against the feudal order in 1967 at Naxalbari in ___.",
        ...
        {
          id: "q1a5",
          question: "The 1971 war between India and Pakistan led to the creation of ___.",
    ...
    },
    {
      ...
      marks: 3,
      instructions: "Identify the incorrect pair in every set, correct it and rewrite",
      questions: [
        {
          id: "q1b1",
    ...
    },
    {
      ...
      marks: 4,
      instructions: "Complete the following statements by using the appropriate options",
      questions: [
        {
          id: "q1c1",
          question: "The post cold war world order was dominated by the United States, because ___.",
          options: [
        ...
        {
          id: "q1c3",
          question: "India was forced to take loan from the International Monetary Fund in 1990, because ___.",
          options: [
        ...
        {
          id: "q1c4",
          question: "There have been tensions between India and Pakistan since independence, because ___.",
          options: [
    ...
    },
    {
      ...
      questions: [
        {
          id: "q1d1",
          statement: "When a state influences other states without the use of military force.",
          answer: "Soft Power",
          marks: 1,
        },
        {
          ...
          answer: "Multinational Corporation (MNC) / Transnational Corporation (TNC)",
          marks: 1,
        },
        {
          id: "q1d3",
          statement: "Introduction of high yielding variety of seeds and irrigation methods.",
          answer: "Green Revolution",
          marks: 1,
        },
        {
          id: "q1d4",
          statement: "A state in which all segments of the society are involved in the making of policy.",
      ...
      questions: [
        {
          ...
          answer: "America",
          reason: "America is not a BRICS member. BRICS = Brazil, Russia, India, China, South Africa",
          marks: 1,
        },
        {
          id: "q1e2",
          ...
          answer: "Education",
          reason: "Education is not a type of Intellectual Property Rights (IPR). Patent, Trademark, and Copyright are forms of IPR.",
          marks: 1,
        },
        {
          id: "q1e3",
          ...
          answer: "Nationalism",
          reason: "Nationalism promotes unity, while Linguism, Regionalism, and Communalism are challenges/threats to national unity.",
          marks: 1,
        },
        {
          id: "q1e4",
          ...
          answer: "Dalai Lama",
          reason: "Dalai Lama is a person (Tibetan spiritual leader), not a state. The others are Indian states.",
          marks: 1,
        },
      ],
    },
    {
      ...
      marks: 10,
      instructions: "State whether the following statements are True or False with reasons (Any FIVE out of 7)",
      required: 5,
      questions: [
        {
          id: "q3_1",
          statement: "The National Commission for Women was created to protect the rights of women.",
          answer: true,
        ...
        {
          id: "q3_2",
          statement: "Lokayukta can investigate complaints against political executives.",
          answer: true,
        ...
        {
          id: "q3_3",
          statement: "The decade of 1980s is seen as the golden age of humanitarian intervention.",
          answer: false,
        ...
        {
          id: "q3_4",
          statement: "Democracy is required to establish national integration and social transformation.",
          answer: true,
        ...
        {
          id: "q3_7",
          statement: "Planning Commission was created to promote agriculture in India.",
          answer: false,
    ...
    },
    {
      ...
      marks: 12,
      instructions: "Express your opinion in 25 to 30 words on the following (Any THREE out of 5)",
      required: 3,
      questions: [
        {
          id: "q5_1",
        ...
        {
          id: "q5_5",
          topic: "Due to globalisation consumers get qualitative goods and services.",
...
const PolSciMockTest: React.FC<PolSciMockTestProps> = ({ onClose }) => {
  ...
  const renderIntro = () => (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center">
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-6">Board Examination Mock Test</p>

      <div className="grid grid-cols-2 gap-4 mb-8 w-full max-w-md">
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl">
          <Clock className="mx-auto text-blue-500 mb-2" size={24} />
          <p className="text-2xl font-bold text-blue-700 dark:text-blue-300">3 Hours</p>
        ...
        <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-xl">
          ...
          <p className="text-2xl font-bold text-green-700 dark:text-green-300">80 Marks</p>
          <p className="text-xs text-green-600 dark:text-green-400">Total Marks</p>
        </div>
      </div>
    ...
    return (
      <div className="p-4 space-y-4">
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl p-4 text-white">
          ...
          <p className="text-white/80 text-sm">{section.instructions}</p>
        ...
        <div className="space-y-4 max-h-[50vh] overflow-y-auto">
          ...
          {section.type === "incorrect_pair" && section.questions.map((q: any, idx: number) => (
            <div key={q.id} className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm">
              ...
              <textarea
                ...
                onChange={(e) => handleAnswer(`${q.id}_correction`, e.target.value)}
          ...
          {section.type === "complete_sentence" && section.questions.map((q: any, idx: number) => (
            <div key={q.id} className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm">
              <p className="font-medium text-slate-800 dark:text-white mb-3">
                <span className="text-indigo-500 mr-2">{idx + 1}.</span>
                {q.question}
          ...
          {section.type === "true_false" && section.questions.map((q: any, idx: number) => (
            <div key={q.id} className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm">
              ...
              <textarea
                ...
                onChange={(e) => handleAnswer(`${q.id}_reason`, e.target.value)}
                className="w-full p-3 rounded-lg bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-sm"
                rows={3}
              />
            </div>
          ...
          {(section.type === "correlation" || section.type === "opinion" || section.type === "short_answer" || section.type === "long_answer") &&
            ...
            <div key={q.id} className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm">
              ...
              {q.points && (
                <div className="flex flex-wrap gap-1 mb-3">
                  {q.points.map((p: string, pIdx: number) => (
                    <span key={pIdx} className="text-xs bg-slate-200 dark:bg-slate-600 px-2 py-1 rounded text-slate-600 dark:text-slate-300">
                      {p}
                    </span>
                  ))}
                </div>
              ...
              <textarea
                ...
                onChange={(e) => handleAnswer(q.id, e.target.value)}
                className="w-full p-3 rounded-lg bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-sm"
                rows={section.type === "long_answer" ? 10 : section.type === "short_answer" ? 6 : 4}
              />
            </div>
          ))}
        </div>
      ...
      <div className="p-4 space-y-4 max-h-[80vh] overflow-y-auto">
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl p-6 text-white text-center">
          ...
          <div className="flex justify-center gap-8">
            <div>
              <p className="text-3xl font-bold">{autoScore}</p>
              <p className="text-sm text-white/80">Auto-graded</p>
            </div>
            <div>
              <p className="text-3xl font-bold">{totalSelfMarks}</p>
              <p className="text-sm text-white/80">Self-evaluated</p>
            </div>
            <div>
              <p className="text-3xl font-bold">{autoScore + totalSelfMarks}/80</p>
        ...
        {MOCK_PAPER_2023.sections.map((section) => (
          <div key={section.id} className="bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-sm">
            <div className="p-4 bg-slate-50 dark:bg-slate-700">
              <h3 className="font-bold text-slate-800 dark:text-white">{section.title}</h3>
            </div>
            <div className="p-4 space-y-4">
              {section.questions.map((q: any, idx: number) => {
                const isCorrect = section.type === "mcq" || section.type === "complete_sentence"
                ...
                return (
                  <div key={q.id} className={`p-4 rounded-xl ${
                    isCorrect === true ? "bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800" :
                    isCorrect === false ? "bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800" :
                    "bg-slate-50 dark:bg-slate-700"
                  }`}>
                    <p className="font-medium text-slate-800 dark:text-white mb-2">
                      {idx + 1}. {q.question || q.statement || q.topic || q.concepts}
                    </p>
                    ...
                    {(section.type === "true_false" || section.type === "correlation" ||
                      section.type === "opinion" || section.type === "short_answer" ||
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg">
                          <p className="text-xs text-green-600 dark:text-green-400 mb-1">Model Answer:</p>
                          <p className="text-sm text-slate-700 dark:text-slate-300 whitespace-pre-wrap">
                            {q.modelAnswer}
                          </p>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="text-sm text-slate-600 dark:text-slate-400">Self-evaluate ({q.marks} marks):</span>
                          <input
                            type="number"
                            min="0"
                            max={q.marks}
                            value={selfMarks[q.id] || 0}
                            onChange={(e) => setSelfMarks(prev => ({
                              ...prev,
                              [q.id]: Math.min(q.marks, Math.max(0, parseInt(e.target.value) || 0))
                            }))}
                            className="w-16 p-2 rounded border dark:bg-slate-700 dark:border-slate-600 text-center"
                          />
                          <span className="text-sm text-slate-500">/ {q.marks}</span>
                        </div>
                      </div>
                    )}
                  </div>
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-slate-100 dark:bg-slate-900 w-full max-w-4xl max-h-[95vh] rounded-2xl overflow-hidden flex flex-col">
        {/* Header */}
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <FileText className="text-white" size={24} />
            <div>
              <h2 className="font-bold text-white">{MOCK_PAPER_2023.title}</h2>
              {testState === "running" && (
                <p className="text-white/80 text-xs">
                  Section {currentSection + 1} of {MOCK_PAPER_2023.sections.length}
                </p>
              )}
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 border-t dark:border-slate-700 p-4">
            <div className="flex items-center justify-between">
              <button
                ...
                className="px-4 py-2 bg-slate-200 dark:bg-slate-700 rounded-lg flex items-center gap-2 disabled:opacity-50"
              >
                <ChevronLeft size={20} />
                Previous
              </button>
              ...
              {currentSection === MOCK_PAPER_2023.sections.length - 1 ? (
                <button
                  onClick={submitTest}
                  className="px-6 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg flex items-center gap-2 font-bold"
                >
                  <Send size={20} />
                  Submit
                </button>
                ...
                <button
                  onClick={() => setCurrentSection(Math.min(MOCK_PAPER_2023.sections.length - 1, currentSection + 1))}
