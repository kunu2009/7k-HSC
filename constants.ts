        ...
        chapters: [
          {
            ...
            flashcards: [
              ...
              { id: 'f9', front: 'What is Humanism?', back: 'Focus on human beings and classical learning, not just religion.' },
              { id: 'f10', front: 'Who wrote The Prince?', back: 'Niccolo Machiavelli.' },
              { id: 'f11', front: 'Who wrote Divine Comedy?', back: 'Dante Alighieri.' },
              { id: 'f12', front: 'Who wrote Praise of Folly?', back: 'Erasmus of Rotterdam.' },
              { id: 'f13', front: 'Which family patronized Renaissance in Florence?', back: 'Medici family.' },
              { id: 'f14', front: 'What event in 1453 helped spread Renaissance?', back: 'Fall of Constantinople - scholars fled to Italy.' },
              { id: 'f15', front: 'What were the Crusades?', back: 'Religious wars that exposed Europeans to Eastern knowledge.' },
              { id: 'f16', front: 'Who painted School of Athens?', back: 'Raphael.' },
              { id: 'f17', front: 'Who sculpted the David statue?', back: 'Michelangelo.' },
              { id: 'f18', front: 'What was Leonardo da Vinci known for?', back: 'Painter, scientist, inventor - Renaissance Man.' },
              { id: 'f19', front: 'What did Galileo invent?', back: 'Improved telescope, discovered laws of motion.' },
              { id: 'f20', front: 'Why did Renaissance start in Italy?', back: 'Trade wealth, Roman heritage, wealthy merchants, city-states.' },
              { id: 'f21', front: 'What is perspective in painting?', back: 'Technique to show depth and 3D on flat surface.' },
              { id: 'f22', front: 'What declined during Renaissance?', back: 'Feudalism and blind faith in Church.' },
              { id: 'f23', front: 'Name major Italian city-states?', back: 'Florence, Venice, Rome, Milan, Naples.' },
              { id: 'f24', front: 'What is vernacular literature?', back: 'Literature in local languages instead of Latin.' },
              { id: 'f25', front: 'What did printing press do?', back: 'Made books cheap, spread ideas quickly.' },
              { id: 'f26', front: 'Renaissance marked transition from?', back: 'Medieval to Modern Era.' },
              { id: 'f27', front: 'What did Renaissance lead to?', back: 'Scientific inquiry, Reformation, nation-states.' },
              { id: 'f28', front: 'Who was a patron of arts?', back: 'Lorenzo de Medici (Lorenzo the Magnificent).' },
              { id: 'f29', front: 'What was Last Supper painting about?', back: 'Jesus\' final meal with disciples before crucifixion.' },
              { id: 'f30', front: 'Geocentric vs Heliocentric?', back: 'Geocentric: Earth center. Heliocentric: Sun center.' }
            ],
            mcqs: [
              ...
              { id: 'q6', question: 'Father of Humanism is:', options: ['Dante', 'Petrarch', 'Erasmus', 'Boccaccio'], correctIndex: 1, explanation: 'Petrarch is called Father of Humanism.' },
              { id: 'q7', question: 'Renaissance means:', options: ['Revolution', 'Rebirth', 'Reform', 'Revolt'], correctIndex: 1, explanation: 'Renaissance means rebirth or revival.' },
              { id: 'q8', question: 'Sistine Chapel ceiling was painted by:', options: ['Leonardo', 'Raphael', 'Michelangelo', 'Donatello'], correctIndex: 2, explanation: 'Michelangelo painted the Sistine Chapel ceiling.' },
              { id: 'q9', question: 'Heliocentric theory was given by:', options: ['Galileo', 'Copernicus', 'Newton', 'Kepler'], correctIndex: 1, explanation: 'Copernicus proposed sun-centered universe.' },
              { id: 'q10', question: 'Which family patronized arts in Florence?', options: ['Borgia', 'Medici', 'Sforza', 'Tudor'], correctIndex: 1, explanation: 'Medici family were great patrons of Renaissance.' },
              { id: 'q11', question: 'Divine Comedy was written by:', options: ['Petrarch', 'Boccaccio', 'Dante', 'Machiavelli'], correctIndex: 2, explanation: 'Dante Alighieri wrote Divine Comedy.' },
              { id: 'q12', question: 'Renaissance started in which century?', options: ['12th', '14th', '16th', '18th'], correctIndex: 1, explanation: '14th century in Italy.' },
              { id: 'q13', question: 'School of Athens was painted by:', options: ['Leonardo', 'Raphael', 'Michelangelo', 'Titian'], correctIndex: 1, explanation: 'Raphael painted School of Athens.' },
              { id: 'q14', question: 'Praise of Folly was written by:', options: ['Luther', 'Calvin', 'Erasmus', 'Zwingli'], correctIndex: 2, explanation: 'Erasmus of Rotterdam wrote Praise of Folly.' },
              { id: 'q15', question: 'David statue was sculpted by:', options: ['Donatello', 'Michelangelo', 'Bernini', 'Ghiberti'], correctIndex: 1, explanation: 'Michelangelo\'s famous marble sculpture.' },
              { id: 'q16', question: 'What spread ideas during Renaissance?', options: ['Radio', 'Television', 'Printing Press', 'Telegraph'], correctIndex: 2, explanation: 'Gutenberg\'s printing press spread ideas.' },
              { id: 'q17', question: 'Renaissance was revival of ______ learning.', options: ['Medieval', 'Greek and Roman', 'Egyptian', 'Chinese'], correctIndex: 1, explanation: 'Classical Greek and Roman knowledge.' },
              { id: 'q18', question: 'Who improved the telescope?', options: ['Copernicus', 'Galileo', 'Kepler', 'Newton'], correctIndex: 1, explanation: 'Galileo improved telescope for astronomy.' },
              { id: 'q19', question: 'Humanism focused on:', options: ['God only', 'Human beings', 'Animals', 'Nature only'], correctIndex: 1, explanation: 'Man is the measure of all things.' },
              { id: 'q20', question: 'Renaissance ended which age?', options: ['Iron Age', 'Dark Ages', 'Stone Age', 'Bronze Age'], correctIndex: 1, explanation: 'Ended Medieval/Dark Ages.' },
              { id: 'q21', question: 'Which was NOT a Renaissance city-state?', options: ['Florence', 'Venice', 'London', 'Rome'], correctIndex: 2, explanation: 'London is in England, not Italy.' },
              { id: 'q22', question: 'Vernacular literature means:', options: ['Latin literature', 'Greek literature', 'Local language literature', 'Religious literature'], correctIndex: 2, explanation: 'Writing in local/native languages.' },
              { id: 'q23', question: 'Leonardo was called:', options: ['Renaissance Man', 'Medieval Man', 'Modern Man', 'Common Man'], correctIndex: 0, explanation: 'Due to his diverse talents.' },
              { id: 'q24', question: 'Crusades exposed Europe to ______ knowledge.', options: ['African', 'American', 'Eastern/Asian', 'Australian'], correctIndex: 2, explanation: 'Arab and Byzantine learning.' },
              { id: 'q25', question: 'What declined during Renaissance?', options: ['Trade', 'Art', 'Feudalism', 'Science'], correctIndex: 2, explanation: 'Feudal system declined.' },
              { id: 'q26', question: 'Renaissance led to which movement?', options: ['Crusades', 'Reformation', 'Feudalism', 'Monarchy'], correctIndex: 1, explanation: 'Questioning led to religious reform.' },
              { id: 'q27', question: 'Last Supper was painted by:', options: ['Michelangelo', 'Raphael', 'Leonardo', 'Titian'], correctIndex: 2, explanation: 'Leonardo da Vinci\'s famous painting.' },
              { id: 'q28', question: 'Perspective in painting creates:', options: ['Flat look', '3D depth effect', 'Abstract art', 'Blur effect'], correctIndex: 1, explanation: 'Shows depth and dimension.' },
              { id: 'q29', question: 'Lorenzo the Magnificent belonged to:', options: ['Borgia', 'Medici', 'Sforza', 'Este'], correctIndex: 1, explanation: 'Famous Medici patron of arts.' },
              { id: 'q30', question: 'What made books cheaper?', options: ['Paper', 'Printing Press', 'Ink', 'Binding'], correctIndex: 1, explanation: 'Mass production of books.' }
            ],
            reels: [
              ...
              { id: 'r9', title: 'Petrarch', content: 'Father of Humanism.\nItalian scholar.\nClassical revival.', color: getReelColor(8) },
              { id: 'r10', title: 'Dante', content: 'Divine Comedy.\nItalian poet.\nVernacular literature.', color: getReelColor(9) },
              { id: 'r11', title: 'Machiavelli', content: 'The Prince.\nPolitical philosophy.\n"Ends justify means."', color: getReelColor(0) },
              { id: 'r12', title: 'Erasmus', content: 'Praise of Folly.\nDutch scholar.\nCriticized Church.', color: getReelColor(1) },
              { id: 'r13', title: 'Raphael', content: 'School of Athens.\nMaster painter.\nYoungest of Big 3.', color: getReelColor(2) },
              { id: 'r14', title: 'Medici Family', content: 'Florence bankers.\nPatrons of arts.\nLorenzo the Magnificent.', color: getReelColor(3) },
              { id: 'r15', title: 'Copernicus', content: 'Heliocentric theory.\nSun is center.\nRevolutionary idea!', color: getReelColor(4) },
              { id: 'r16', title: 'Galileo', content: 'Improved telescope.\nSupported Copernicus.\nFather of Modern Science.', color: getReelColor(5) },
              { id: 'r17', title: 'City-States', content: 'Florence, Venice, Rome.\nMilan, Naples.\nWealth and rivalry.', color: getReelColor(6) },
              { id: 'r18', title: 'Crusades', content: 'Holy wars.\nExposed Europe to East.\nNew ideas came.', color: getReelColor(7) },
              { id: 'r19', title: 'Perspective', content: 'Art technique.\n3D on 2D surface.\nRealistic paintings.', color: getReelColor(8) },
              { id: 'r20', title: 'Dark Ages End', content: 'Medieval period ends.\nModern Era begins.\nEnlightenment starts.', color: getReelColor(9) },
              { id: 'r21', title: 'Vernacular', content: 'Local languages used.\nNot just Latin.\nMore people read.', color: getReelColor(0) },
              { id: 'r22', title: 'Feudalism Decline', content: 'Lords lost power.\nMerchants rose.\nNew middle class.', color: getReelColor(1) },
              { id: 'r23', title: 'Renaissance Man', content: 'Multi-talented person.\nLeonardo da Vinci.\nExpert in many fields.', color: getReelColor(2) },
              { id: 'r24', title: 'Scientific Method', content: 'Observation.\nExperiment.\nProof required.', color: getReelColor(3) },
              { id: 'r25', title: 'Mona Lisa', content: 'Most famous painting.\nLeonardo\'s masterpiece.\nMysterious smile.', color: getReelColor(4) },
              { id: 'r26', title: 'Sistine Chapel', content: 'Vatican City.\nMichelangelo\'s ceiling.\n4 years to paint!', color: getReelColor(5) },
              { id: 'r27', title: 'David Statue', content: 'Marble masterpiece.\n17 feet tall.\nSymbol of Florence.', color: getReelColor(6) },
              { id: 'r28', title: 'Trade Routes', content: 'New discoveries.\nWealth flowed in.\nFunded arts.', color: getReelColor(7) },
              { id: 'r29', title: 'Church Criticized', content: 'Questioned blind faith.\nLed to Reformation.\nMartin Luther next.', color: getReelColor(8) },
              { id: 'r30', title: 'Legacy', content: 'Art, Science, Literature.\nModern world born.\nStill inspires today!', color: getReelColor(9) }
            ]
          },
          {
            id: 'his2',
            ...
            flashcards: [
              ...
              { id: 'f8', front: 'Where were 95 Theses nailed?', back: 'Church door in Wittenberg, Germany.' },
              { id: 'f9', front: 'What is Simony?', back: 'Buying and selling of religious positions/offices.' },
              { id: 'f10', front: 'What is Nepotism?', back: 'Favoring relatives for positions in Church.' },
              { id: 'f11', front: 'What is Peter\'s Pence?', back: 'Tax paid to the Pope by Catholic countries.' },
              { id: 'f12', front: 'Luther\'s three principles?', back: 'Faith alone, Scripture alone, Grace alone.' },
              { id: 'f13', front: 'Council of Trent years?', back: '1545-1563 (Counter-Reformation council).' },
              { id: 'f14', front: 'Who started Presbyterianism?', back: 'John Knox in Scotland.' },
              { id: 'f15', front: 'What is Predestination?', back: 'Belief that God has predetermined who will be saved.' },
              { id: 'f16', front: 'Why did Henry VIII break from Rome?', back: 'Pope refused to grant divorce from Catherine of Aragon.' },
              { id: 'f17', front: 'What was the Inquisition?', back: 'Church court to punish heretics (those against Church).' },
              { id: 'f18', front: 'When was Act of Supremacy?', back: '1534 - Made English monarch head of Church of England.' },
              { id: 'f19', front: 'Zwingli was reformer in?', back: 'Switzerland (Zurich).' },
              { id: 'f20', front: 'What happened to Luther after 95 Theses?', back: 'Excommunicated by Pope, protected by German princes.' },
              { id: 'f21', front: 'Jesuits full name?', back: 'Society of Jesus - founded by Ignatius Loyola.' },
              { id: 'f22', front: 'What did printing press do for Reformation?', back: 'Spread reformist ideas and Bible translations quickly.' },
              { id: 'f23', front: 'Protestant means?', back: 'One who protests - against Catholic Church practices.' },
              { id: 'f24', front: 'Lutheran Church started in?', back: 'Germany, by Martin Luther.' },
              { id: 'f25', front: 'Reformation divided Europe into?', back: 'Catholic (South) and Protestant (North).' },
              { id: 'f26', front: 'Bible was translated to help?', back: 'Common people read God\'s word directly.' },
              { id: 'f27', front: 'Who sold indulgences that angered Luther?', back: 'Johann Tetzel - "When the coin in the coffer rings..."' },
              { id: 'f28', front: 'What wars did Reformation cause?', back: 'Religious wars like Thirty Years War (1618-1648).' },
              { id: 'f29', front: 'Reformation promoted?', back: 'Literacy and education for all to read Bible.' },
              { id: 'f30', front: 'Diet of Worms (1521)?', back: 'Assembly where Luther refused to recant his views.' }
            ],
            mcqs: [
              ...
              { id: 'q6', question: 'Predestination was preached by:', options: ['Luther', 'Calvin', 'Zwingli', 'Knox'], correctIndex: 1, explanation: 'John Calvin\'s core belief.' },
              { id: 'q7', question: '95 Theses were nailed at:', options: ['Rome', 'Geneva', 'Wittenberg', 'London'], correctIndex: 2, explanation: 'Church door in Wittenberg, Germany.' },
              { id: 'q8', question: 'Act of Supremacy was passed in:', options: ['1517', '1534', '1545', '1555'], correctIndex: 1, explanation: 'Made Henry VIII head of Church of England.' },
              { id: 'q9', question: 'Simony means:', options: ['Selling positions', 'Selling indulgences', 'Nepotism', 'Heresy'], correctIndex: 0, explanation: 'Buying and selling church offices.' },
              { id: 'q10', question: 'Presbyterian Church was started by:', options: ['Calvin', 'Luther', 'Knox', 'Zwingli'], correctIndex: 2, explanation: 'John Knox in Scotland.' },
              { id: 'q11', question: 'Counter-Reformation was led by:', options: ['Protestant Church', 'Catholic Church', 'Anglican Church', 'Orthodox Church'], correctIndex: 1, explanation: 'Catholic response to reform itself.' },
              { id: 'q12', question: 'Luther was ______ by the Pope.', options: ['Rewarded', 'Excommunicated', 'Promoted', 'Ignored'], correctIndex: 1, explanation: 'Thrown out of Catholic Church.' },
              { id: 'q13', question: 'Reformation started in which country?', options: ['England', 'France', 'Germany', 'Italy'], correctIndex: 2, explanation: 'Martin Luther was German.' },
              { id: 'q14', question: 'Inquisition was used to:', options: ['Reward saints', 'Punish heretics', 'Elect Pope', 'Collect taxes'], correctIndex: 1, explanation: 'Church court against those opposing Church.' },
              { id: 'q15', question: 'Peter\'s Pence was:', options: ['Coin', 'Tax to Pope', 'Church building', 'Bible'], correctIndex: 1, explanation: 'Annual tax to Rome.' },
              { id: 'q16', question: 'Luther\'s principle was "Faith ______".', options: ['And works', 'Alone', 'Is secondary', 'Is optional'], correctIndex: 1, explanation: 'Salvation by faith alone, not works.' },
              { id: 'q17', question: 'Henry VIII wanted divorce from:', options: ['Anne Boleyn', 'Catherine of Aragon', 'Jane Seymour', 'Mary I'], correctIndex: 1, explanation: 'Pope refused, so he broke from Rome.' },
              { id: 'q18', question: 'Council of Trent lasted:', options: ['5 years', '10 years', '18 years', '25 years'], correctIndex: 2, explanation: '1545-1563 = 18 years.' },
              { id: 'q19', question: 'Jesuits were known for:', options: ['Warfare', 'Education', 'Trade', 'Agriculture'], correctIndex: 1, explanation: 'Established schools and colleges.' },
              { id: 'q20', question: 'Diet of Worms was held in:', options: ['1517', '1521', '1534', '1545'], correctIndex: 1, explanation: 'Luther refused to take back his words.' },
              { id: 'q21', question: 'Johann Tetzel sold:', options: ['Books', 'Indulgences', 'Land', 'Art'], correctIndex: 1, explanation: 'His sales angered Luther.' },
              { id: 'q22', question: 'Protestant means one who:', options: ['Supports', 'Protests', 'Ignores', 'Accepts'], correctIndex: 1, explanation: 'Those protesting Church practices.' },
              { id: 'q23', question: 'Thirty Years War was fought over:', options: ['Trade', 'Religion', 'Land', 'Monarchy'], correctIndex: 1, explanation: 'Catholics vs Protestants (1618-1648).' },
              { id: 'q24', question: 'Reformation promoted:', options: ['Illiteracy', 'Literacy', 'Ignorance', 'Blind faith'], correctIndex: 1, explanation: 'So people could read Bible.' },
              { id: 'q25', question: 'Zwingli reformed church in:', options: ['Germany', 'England', 'Switzerland', 'Scotland'], correctIndex: 2, explanation: 'Zurich, Switzerland.' },
              { id: 'q26', question: 'Vernacular Bible means Bible in:', options: ['Latin', 'Greek', 'Local language', 'Hebrew'], correctIndex: 2, explanation: 'Native language of people.' },
              { id: 'q27', question: 'Catholic vs Protestant division created:', options: ['Unity', 'Division in Christianity', 'Peace', 'Harmony'], correctIndex: 1, explanation: 'Western Christianity split.' },
              { id: 'q28', question: 'Who protected Luther after excommunication?', options: ['Pope', 'German princes', 'King of France', 'English king'], correctIndex: 1, explanation: 'Frederick the Wise and others.' },
              { id: 'q29', question: 'Nepotism means favoring:', options: ['Friends', 'Relatives', 'Enemies', 'Strangers'], correctIndex: 1, explanation: 'Giving positions to family.' },
              { id: 'q30', question: 'Reformation led to rise of:', options: ['Feudalism', 'Nation-states', 'Monarchy', 'Empires'], correctIndex: 1, explanation: 'Kings gained power from Pope.' }
            ],
            reels: [
              ...
              { id: 'r9', title: '95 Theses', content: 'Nailed to church door.\nWittenberg, Germany.\nOctober 31, 1517.', color: getReelColor(8) },
              { id: 'r10', title: 'Simony', content: 'Buying church positions.\nCorruption in Church.\nLuther criticized.', color: getReelColor(9) },
              { id: 'r11', title: 'Nepotism', content: 'Relatives get positions.\nFamily favoritism.\nChurch abuse.', color: getReelColor(0) },
              { id: 'r12', title: 'Jesuits', content: 'Society of Jesus.\nIgnatius Loyola.\nEducation and missions.', color: getReelColor(1) },
              { id: 'r13', title: 'Council of Trent', content: '1545-1563.\nCatholic reforms.\n18 years of debate.', color: getReelColor(2) },
              { id: 'r14', title: 'Inquisition', content: 'Church court.\nPunish heretics.\nFear and control.', color: getReelColor(3) },
              { id: 'r15', title: 'John Knox', content: 'Scottish reformer.\nPresbyterian Church.\nStrict Calvinist.', color: getReelColor(4) },
              { id: 'r16', title: 'Zwingli', content: 'Swiss reformer.\nZurich reforms.\nDied in battle.', color: getReelColor(5) },
              { id: 'r17', title: 'Diet of Worms', content: '1521 assembly.\nLuther stood firm.\n"Here I stand!"', color: getReelColor(6) },
              { id: 'r18', title: 'Excommunication', content: 'Luther kicked out.\nBy Pope Leo X.\n1521.', color: getReelColor(7) },
              { id: 'r19', title: 'Act of Supremacy', content: '1534.\nKing = Head of Church.\nEngland\'s break.', color: getReelColor(8) },
              { id: 'r20', title: 'Predestination', content: 'Calvin\'s belief.\nGod chose already.\nNo changing fate.', color: getReelColor(9) },
              { id: 'r21', title: 'Peter\'s Pence', content: 'Tax to Pope.\nEvery year.\nKings resented.', color: getReelColor(0) },
              { id: 'r22', title: 'Johann Tetzel', content: 'Indulgence seller.\nFamous slogan.\nAngered Luther.', color: getReelColor(1) },
              { id: 'r23', title: 'Protestant', content: 'One who protests.\nAgainst Catholic ways.\nNew churches.', color: getReelColor(2) },
              { id: 'r24', title: 'Vernacular Bible', content: 'In local language.\nEveryone can read.\nPower to people.', color: getReelColor(3) },
              { id: 'r25', title: 'Printing Press', content: 'Spread Luther\'s ideas.\nBibles printed.\nReformation fuel.', color: getReelColor(4) },
              { id: 'r26', title: 'Religious Wars', content: 'Thirty Years War.\n1618-1648.\nMillions died.', color: getReelColor(5) },
              { id: 'r27', title: 'Education', content: 'Protestants promoted.\nRead the Bible.\nSchools increased.', color: getReelColor(6) },
              { id: 'r28', title: 'Nation-States', content: 'Kings gained power.\nLess Pope control.\nModern nations.', color: getReelColor(7) },
              { id: 'r29', title: 'North vs South', content: 'North = Protestant.\nSouth = Catholic.\nEurope divided.', color: getReelColor(8) },
              { id: 'r30', title: 'Legacy', content: 'Religious freedom.\nEducation for all.\nModern democracy seeds.', color: getReelColor(9) }
            ]
          },
          {
            id: 'his3',
            ...
            flashcards: [
              ...
              { id: 'f8', front: 'Why England first? (Geography)', back: 'Rich coal & iron, rivers, island safety, good harbors.' },
              { id: 'f9', front: 'Why England first? (Economy)', back: 'Colonial wealth, strong banks, trade, capital.' },
              { id: 'f10', front: 'What is cottage industry?', back: 'Production done in homes, not factories.' },
              { id: 'f11', front: 'Flying Shuttle inventor?', back: 'John Kay (1733) - faster weaving.' },
              { id: 'f12', front: 'Water Frame inventor?', back: 'Richard Arkwright (1769) - water-powered spinning.' },
              { id: 'f13', front: 'Spinning Mule inventor?', back: 'Samuel Crompton (1779) - combined jenny & frame.' },
              { id: 'f14', front: 'What fueled steam engines?', back: 'Coal - abundant in England.' },
              { id: 'f15', front: 'Bessemer Process (1856)?', back: 'Cheap method to make steel from iron.' },
              { id: 'f16', front: 'What is Urbanization?', back: 'Movement of people from villages to cities.' },
              { id: 'f17', front: 'Who are Bourgeoisie?', back: 'Middle class - factory owners, businessmen.' },
              { id: 'f18', front: 'Who are Proletariat?', back: 'Working class - factory workers.' },
              { id: 'f19', front: 'What are Trade Unions?', back: 'Organizations of workers to fight for rights.' },
              { id: 'f20', front: 'Problems of industrialization?', back: 'Child labor, long hours, unsafe conditions, pollution.' },
              { id: 'f21', front: 'Agricultural Revolution freed?', back: 'Labor - new farming methods needed fewer workers.' },
              { id: 'f22', front: 'Patent laws helped how?', back: 'Protected inventors - encouraged innovation.' },
              { id: 'f23', front: 'First steamship?', back: 'Robert Fulton\'s Clermont (1807).' },
              { id: 'f24', front: 'What is Capitalism?', back: 'Economic system where private owners control production for profit.' },
              { id: 'f25', front: 'Who wrote Das Kapital?', back: 'Karl Marx - criticized industrial capitalism.' },
              { id: 'f26', front: 'Luddites were?', back: 'Workers who destroyed machines (feared job loss).' },
              { id: 'f27', front: 'Factory Act 1833?', back: 'Limited child labor hours in British factories.' },
              { id: 'f28', front: 'Industrial Rev spread to?', back: 'Belgium, France, Germany, USA.' },
              { id: 'f29', front: 'Enclosure Movement?', back: 'Common lands fenced - forced peasants to cities.' },
              { id: 'f30', front: 'Second Industrial Revolution?', back: 'Late 1800s - electricity, chemicals, steel.' }
            ],
            mcqs: [
              ...
              { id: 'q6', question: 'Flying Shuttle was invented by:', options: ['John Kay', 'Watt', 'Darby', 'Fulton'], correctIndex: 0, explanation: 'John Kay in 1733 - sped up weaving.' },
              { id: 'q7', question: 'Water Frame was invented by:', options: ['Crompton', 'Arkwright', 'Hargreaves', 'Kay'], correctIndex: 1, explanation: 'Richard Arkwright - water-powered spinning.' },
              { id: 'q8', question: 'Bessemer Process was for:', options: ['Cotton', 'Iron to Steel', 'Coal mining', 'Weaving'], correctIndex: 1, explanation: 'Cheap steel production from iron.' },
              { id: 'q9', question: 'Bourgeoisie means:', options: ['Workers', 'Middle class', 'Nobles', 'Peasants'], correctIndex: 1, explanation: 'Factory owners and businessmen.' },
              { id: 'q10', question: 'Proletariat means:', options: ['Owners', 'Workers', 'Farmers', 'Kings'], correctIndex: 1, explanation: 'Working class in factories.' },
              { id: 'q11', question: 'Urbanization means:', options: ['Farming', 'Rural growth', 'City growth', 'Deforestation'], correctIndex: 2, explanation: 'People moving from villages to cities.' },
              { id: 'q12', question: 'Das Kapital was written by:', options: ['Adam Smith', 'Karl Marx', 'Engels', 'Watt'], correctIndex: 1, explanation: 'Marx\'s critique of capitalism.' },
              { id: 'q13', question: 'Luddites destroyed:', options: ['Farms', 'Machines', 'Churches', 'Ships'], correctIndex: 1, explanation: 'Workers feared machines taking jobs.' },
              { id: 'q14', question: 'Factory Act 1833 limited:', options: ['Child labor', 'Taxes', 'Imports', 'Wages'], correctIndex: 0, explanation: 'Protected children from exploitation.' },
              { id: 'q15', question: 'First steamship was by:', options: ['Watt', 'Stephenson', 'Fulton', 'Kay'], correctIndex: 2, explanation: 'Robert Fulton\'s Clermont in 1807.' },
              { id: 'q16', question: 'Trade Unions fought for:', options: ['Factory owners', 'Workers\' rights', 'King\'s power', 'Church'], correctIndex: 1, explanation: 'Better wages and conditions.' },
              { id: 'q17', question: 'Enclosure Movement caused:', options: ['More jobs', 'Migration to cities', 'Better farming', 'All of these'], correctIndex: 3, explanation: 'All are correct effects.' },
              { id: 'q18', question: 'Industrial Rev started around:', options: ['1660', '1760', '1860', '1900'], correctIndex: 1, explanation: 'Mid-18th century in England.' },
              { id: 'q19', question: 'England had advantage of:', options: ['Coal and iron', 'Colonies', 'Stable government', 'All of these'], correctIndex: 3, explanation: 'Multiple factors helped England.' },
              { id: 'q20', question: 'Cottage industry means:', options: ['Factory work', 'Home production', 'Mining', 'Farming'], correctIndex: 1, explanation: 'Production done in homes.' },
              { id: 'q21', question: 'Patent laws protected:', options: ['Workers', 'Inventors', 'Kings', 'Farmers'], correctIndex: 1, explanation: 'Encouraged innovation by protecting inventions.' },
              { id: 'q22', question: 'Steam engine used:', options: ['Coal', 'Oil', 'Electricity', 'Wood'], correctIndex: 0, explanation: 'Coal was the primary fuel.' },
              { id: 'q23', question: 'Railways revolutionized:', options: ['Agriculture', 'Transport', 'Religion', 'Art'], correctIndex: 1, explanation: 'Faster movement of goods and people.' },
              { id: 'q24', question: 'Second Industrial Revolution brought:', options: ['Electricity', 'Steam', 'Water power', 'Wind power'], correctIndex: 0, explanation: 'Late 1800s saw electricity and chemicals.' },
              { id: 'q25', question: 'Capitalism emphasizes:', options: ['State control', 'Private ownership', 'Church control', 'Common ownership'], correctIndex: 1, explanation: 'Private ownership for profit.' },
              { id: 'q26', question: 'Child labor was ______ during Industrial Rev.', options: ['Banned', 'Common', 'Unknown', 'Rare'], correctIndex: 1, explanation: 'Children worked long hours in factories.' },
              { id: 'q27', question: 'Agricultural Revolution freed:', options: ['Money', 'Land', 'Labor', 'Animals'], correctIndex: 2, explanation: 'Fewer workers needed on farms.' },
              { id: 'q28', question: 'Power Loom inventor:', options: ['Kay', 'Cartwright', 'Watt', 'Darby'], correctIndex: 1, explanation: 'Edmund Cartwright in 1785.' },
              { id: 'q29', question: 'Industrial Rev led to rise of:', options: ['Feudalism', 'Socialism', 'Monarchy', 'Tribalism'], correctIndex: 1, explanation: 'Workers\' movements and socialism.' },
              { id: 'q30', question: 'England was safe because it was:', options: ['Large', 'Island', 'Religious', 'Poor'], correctIndex: 1, explanation: 'Island protected from wars.' }
            ],
            reels: [
              ...
              { id: 'r9', title: 'Flying Shuttle', content: 'John Kay - 1733.\nFaster weaving.\nStarted it all.', color: getReelColor(8) },
              { id: 'r10', title: 'Spinning Jenny', content: 'Hargreaves - 1764.\nMultiple spindles.\n8x faster!', color: getReelColor(9) },
              { id: 'r11', title: 'Water Frame', content: 'Arkwright - 1769.\nWater-powered.\nStronger thread.', color: getReelColor(0) },
              { id: 'r12', title: 'Spinning Mule', content: 'Crompton - 1779.\nBest of both.\nFine cotton.', color: getReelColor(1) },
              { id: 'r13', title: 'Power Loom', content: 'Cartwright - 1785.\nMechanized weaving.\nComplete automation.', color: getReelColor(2) },
              { id: 'r14', title: 'Bessemer Process', content: '1856.\nIron → Steel.\nCheap and fast.', color: getReelColor(3) },
              { id: 'r15', title: 'Steamship', content: 'Fulton\'s Clermont.\n1807.\nOcean travel faster.', color: getReelColor(4) },
              { id: 'r16', title: 'Coal Power', content: 'Black gold.\nFueled steam.\nEngland rich in it.', color: getReelColor(5) },
              { id: 'r17', title: 'Iron Deposits', content: 'Raw material.\nMachines made.\nEngland had plenty.', color: getReelColor(6) },
              { id: 'r18', title: 'Capitalism', content: 'Private ownership.\nProfit motive.\nFree market.', color: getReelColor(7) },
              { id: 'r19', title: 'Karl Marx', content: 'Das Kapital.\nCriticized capitalism.\nSocialism founder.', color: getReelColor(8) },
              { id: 'r20', title: 'Luddites', content: 'Machine breakers.\nFeared job loss.\nNed Ludd.', color: getReelColor(9) },
              { id: 'r21', title: 'Child Labor', content: 'Children worked.\nLong hours.\nDangerous conditions.', color: getReelColor(0) },
              { id: 'r22', title: 'Factory Act 1833', content: 'Limited child work.\nMax 9 hours.\nProtection began.', color: getReelColor(1) },
              { id: 'r23', title: 'Trade Unions', content: 'Workers united.\nFought for rights.\nBetter wages.', color: getReelColor(2) },
              { id: 'r24', title: 'Urbanization', content: 'Village → City.\nFactory jobs.\nSlums grew.', color: getReelColor(3) },
              { id: 'r25', title: 'Patent Laws', content: 'Protect inventors.\nEncourage innovation.\nEngland had them.', color: getReelColor(4) },
              { id: 'r26', title: 'Enclosure', content: 'Common land fenced.\nPeasants displaced.\nTo cities.', color: getReelColor(5) },
              { id: 'r27', title: 'Cottage Industry', content: 'Home production.\nPre-factory.\nFamily work.', color: getReelColor(6) },
              { id: 'r28', title: 'Mass Production', content: 'Many goods.\nLower prices.\nMore consumers.', color: getReelColor(7) },
              { id: 'r29', title: 'Second Industrial', content: 'Late 1800s.\nElectricity.\nChemicals. Steel.', color: getReelColor(8) },
              { id: 'r30', title: 'Legacy', content: 'Modern world.\nGlobalization.\nStill impacts today.', color: getReelColor(9) }
            ]
          },
          {
            id: 'his4',
            ...
            flashcards: [
              ...
              { id: 'f8', front: 'What was Bastille?', back: 'Prison in Paris - symbol of royal tyranny.' },
              { id: 'f9', front: 'What was the First Estate?', back: 'Clergy (Church) - 1% of population, no taxes.' },
              { id: 'f10', front: 'What was the Second Estate?', back: 'Nobility - 2% of population, no taxes.' },
              { id: 'f11', front: 'Who was Marie Antoinette?', back: 'Queen of France, wife of Louis XVI - executed.' },
              { id: 'f12', front: 'What were Estates-General?', back: 'French parliament - met after 175 years in 1789.' },
              { id: 'f13', front: 'What was the National Assembly?', back: 'Third Estate formed their own assembly in 1789.' },
              { id: 'f14', front: 'Who was Robespierre?', back: 'Leader of Reign of Terror - executed 40,000.' },
              { id: 'f15', front: 'What was the guillotine?', back: 'Machine for execution by beheading.' },
              { id: 'f16', front: 'Who was Voltaire?', back: 'Philosopher who advocated freedom of speech.' },
              { id: 'f17', front: 'Who was Montesquieu?', back: 'Philosopher - Separation of Powers idea.' },
              { id: 'f18', front: 'What ended the French Revolution?', back: 'Rise of Napoleon Bonaparte in 1799.' },
              { id: 'f19', front: 'Declaration of Rights of Man (1789)?', back: 'Document declaring rights and freedoms.' },
              { id: 'f20', front: 'Why was France bankrupt?', back: 'Wars, American Revolution support, royal extravagance.' },
              { id: 'f21', front: 'What are tithes?', back: 'Tax to Church - 1/10th of income.' },
              { id: 'f22', front: 'What is feudalism?', back: 'System where nobles owned land, peasants worked it.' },
              { id: 'f23', front: 'When was Louis XVI executed?', back: 'January 21, 1793 - guillotined.' },
              { id: 'f24', front: 'Tricolor of France?', back: 'Blue, White, Red - Revolution symbol.' },
              { id: 'f25', front: 'What was Jacobin Club?', back: 'Radical political club - Robespierre\'s group.' },
              { id: 'f26', front: 'Girondins vs Jacobins?', back: 'Girondins (moderate) vs Jacobins (radical).' },
              { id: 'f27', front: 'When was Robespierre executed?', back: 'July 28, 1794 - end of Terror.' },
              { id: 'f28', front: 'What sparked bread riots?', back: 'Food shortage, high prices, starving people.' },
              { id: 'f29', front: 'Women\'s March to Versailles?', back: 'October 1789 - demanded bread from king.' },
              { id: 'f30', front: 'Napoleon became Emperor in?', back: '1804 - crowned himself.' }
            ],
            mcqs: [
              ...
              { id: 'q6', question: 'First Estate was:', options: ['Nobles', 'Clergy', 'Peasants', 'Bourgeoisie'], correctIndex: 1, explanation: 'Church/Clergy formed First Estate.' },
              { id: 'q7', question: 'Tennis Court Oath was taken by:', options: ['First Estate', 'Second Estate', 'Third Estate', 'King'], correctIndex: 2, explanation: 'Third Estate vowed to write constitution.' },
              { id: 'q8', question: 'Louis XVI was executed in:', options: ['1789', '1791', '1793', '1799'], correctIndex: 2, explanation: 'January 21, 1793.' },
              { id: 'q9', question: 'Motto of French Revolution:', options: ['Liberty, Equality, Fraternity', 'Unity in Diversity', 'Jai Hind', 'Vive la France'], correctIndex: 0, explanation: 'The famous revolutionary motto.' },
              { id: 'q10', question: 'Marie Antoinette was ______ of France.', options: ['Princess', 'Queen', 'Sister', 'Daughter'], correctIndex: 1, explanation: 'Wife of Louis XVI.' },
              { id: 'q11', question: 'Separation of Powers was idea of:', options: ['Rousseau', 'Voltaire', 'Montesquieu', 'Diderot'], correctIndex: 2, explanation: 'Legislature, Executive, Judiciary separate.' },
              { id: 'q12', question: 'Estates-General met after ______ years.', options: ['50', '100', '175', '200'], correctIndex: 2, explanation: 'Last met in 1614, then 1789.' },
              { id: 'q13', question: 'Declaration of Rights was in:', options: ['July 1789', 'August 1789', 'January 1793', '1799'], correctIndex: 1, explanation: 'August 26, 1789.' },
              { id: 'q14', question: 'Guillotine was used for:', options: ['Writing', 'Execution', 'Farming', 'Weaving'], correctIndex: 1, explanation: 'Beheading device.' },
              { id: 'q15', question: 'Jacobins were:', options: ['Moderate', 'Radical', 'Royal supporters', 'Clergy'], correctIndex: 1, explanation: 'Radical revolutionaries.' },
              { id: 'q16', question: 'Robespierre was executed in:', options: ['1792', '1793', '1794', '1795'], correctIndex: 2, explanation: 'July 28, 1794 - Thermidorian Reaction.' },
              { id: 'q17', question: 'Tricolor of France is:', options: ['Red, White, Blue', 'Blue, White, Red', 'Green, White, Red', 'Blue, Red, White'], correctIndex: 1, explanation: 'Revolutionary flag colors.' },
              { id: 'q18', question: 'Tithes were paid to:', options: ['King', 'Nobles', 'Church', 'Army'], correctIndex: 2, explanation: '1/10th of income to Church.' },
              { id: 'q19', question: 'France supported which revolution?', options: ['Russian', 'Chinese', 'American', 'Industrial'], correctIndex: 2, explanation: 'Helped American independence, caused debt.' },
              { id: 'q20', question: 'Bastille was a:', options: ['Palace', 'Church', 'Prison', 'Factory'], correctIndex: 2, explanation: 'Symbol of royal oppression.' },
              { id: 'q21', question: 'Women\'s March was in:', options: ['July 1789', 'August 1789', 'October 1789', 'January 1790'], correctIndex: 2, explanation: 'Demanded bread from Versailles.' },
              { id: 'q22', question: 'Napoleon became Emperor in:', options: ['1799', '1801', '1804', '1815'], correctIndex: 2, explanation: 'Crowned himself.' },
              { id: 'q23', question: 'Bourgeoisie were:', options: ['Nobles', 'Peasants', 'Middle class', 'Clergy'], correctIndex: 2, explanation: 'Merchants, professionals in Third Estate.' },
              { id: 'q24', question: 'National Assembly was formed by:', options: ['First Estate', 'King', 'Third Estate', 'Army'], correctIndex: 2, explanation: 'June 1789 - Third Estate broke away.' },
              { id: 'q25', question: 'Reign of Terror killed about:', options: ['1,000', '10,000', '40,000', '100,000'], correctIndex: 2, explanation: 'Estimated 40,000 executions.' },
              { id: 'q26', question: 'Feudalism was:', options: ['Supported', 'Abolished', 'Strengthened', 'Ignored'], correctIndex: 1, explanation: 'Ended by Revolution.' },
              { id: 'q27', question: 'Girondins were:', options: ['Radical', 'Moderate', 'Royalists', 'Clergy'], correctIndex: 1, explanation: 'Opposed by radical Jacobins.' },
              { id: 'q28', question: 'Enlightenment influenced:', options: ['Industry', 'Revolution', 'Church', 'Military'], correctIndex: 1, explanation: 'Ideas of liberty, equality.' },
              { id: 'q29', question: 'Committee of Public Safety led by:', options: ['Napoleon', 'Louis', 'Robespierre', 'Voltaire'], correctIndex: 2, explanation: 'During Reign of Terror.' },
              { id: 'q30', question: 'Revolution spread ideas of:', options: ['Monarchy', 'Feudalism', 'Nationalism', 'Slavery'], correctIndex: 2, explanation: 'Nationalism across Europe.' }
            ],
            reels: [
              ...
              { id: 'r9', title: 'Louis XVI', content: 'Last king.\nWeak ruler.\nExecuted 1793.', color: getReelColor(8) },
              { id: 'r10', title: 'Marie Antoinette', content: 'Austrian queen.\nExtravagant.\nExecuted 1793.', color: getReelColor(9) },
              { id: 'r11', title: 'Tennis Court Oath', content: 'June 20, 1789.\nThird Estate vow.\nWrite constitution!', color: getReelColor(0) },
              { id: 'r12', title: 'National Assembly', content: 'Third Estate.\nOwn parliament.\nPeople\'s voice!', color: getReelColor(1) },
              { id: 'r13', title: 'Guillotine', content: 'Execution machine.\nQuick death.\nSymbol of Terror.', color: getReelColor(2) },
              { id: 'r14', title: 'Robespierre', content: 'Jacobin leader.\nReign of Terror.\nExecuted himself!', color: getReelColor(3) },
              { id: 'r15', title: 'Jacobins', content: 'Radical club.\nLed Terror.\nRobespierre\'s group.', color: getReelColor(4) },
              { id: 'r16', title: 'Girondins', content: 'Moderate group.\nOpposed Jacobins.\nMany executed.', color: getReelColor(5) },
              { id: 'r17', title: 'Declaration', content: 'Rights of Man.\nAugust 1789.\nAll men equal.', color: getReelColor(6) },
              { id: 'r18', title: 'Bread Riots', content: 'People starving.\nHigh prices.\nFury against king.', color: getReelColor(7) },
              { id: 'r19', title: 'Women\'s March', content: 'October 1789.\nTo Versailles.\n"Give us bread!"', color: getReelColor(8) },
              { id: 'r20', title: 'Tricolor', content: 'Blue, White, Red.\nRevolution flag.\nStill France\'s flag!', color: getReelColor(9) },
              { id: 'r21', title: 'Estates-General', content: 'May 1789.\nAfter 175 years.\nKing needs money.', color: getReelColor(0) },
              { id: 'r22', title: 'Tithes', content: 'Church tax.\n1/10th income.\nBurden on poor.', color: getReelColor(1) },
              { id: 'r23', title: 'Feudalism Ends', content: 'No more lords.\nNo more dues.\nPeasants free!', color: getReelColor(2) },
              { id: 'r24', title: 'American Impact', content: 'France helped USA.\nGot no money.\nInspired by liberty.', color: getReelColor(3) },
              { id: 'r25', title: 'Enlightenment', content: 'New ideas.\nReason over tradition.\nInspired revolution.', color: getReelColor(4) },
              { id: 'r26', title: 'Rousseau', content: 'Social Contract.\nPeople\'s will.\nDemocracy idea.', color: getReelColor(5) },
              { id: 'r27', title: 'Voltaire', content: 'Free speech.\nCriticize church.\nPen mightier!', color: getReelColor(6) },
              { id: 'r28', title: 'Montesquieu', content: 'Three branches.\nSeparate powers.\nNo tyranny.', color: getReelColor(7) },
              { id: 'r29', title: 'Nationalism', content: 'Love for nation.\nSpread across Europe.\nRevolution\'s gift.', color: getReelColor(8) },
              { id: 'r30', title: 'Legacy', content: 'Modern democracy.\nHuman rights.\nChanged the world!', color: getReelColor(9) }
            ]
          },
          {
            id: 'his5',
            ...
            flashcards: [
              ...
              { id: 'f9', front: 'When was Franz Ferdinand assassinated?', back: 'June 28, 1914, in Sarajevo.' },
              { id: 'f10', front: 'What was Triple Alliance?', back: 'Germany, Austria-Hungary, Italy.' },
              { id: 'f11', front: 'What was Triple Entente?', back: 'Britain, France, Russia.' },
              { id: 'f12', front: 'Why was Balkans "Powder Keg"?', back: 'Nationalist tensions ready to explode into war.' },
              { id: 'f13', front: 'What was trench warfare?', back: 'Soldiers fighting from trenches - years of stalemate.' },
              { id: 'f14', front: 'When did USA enter WWI?', back: '1917 - after Lusitania sinking.' },
              { id: 'f15', front: 'What was Lusitania?', back: 'British ship sunk by German submarine - killed Americans.' },
              { id: 'f16', front: 'When did WWI end?', back: 'November 11, 1918 (Armistice Day).' },
              { id: 'f17', front: 'When was Treaty of Versailles signed?', back: 'June 28, 1919.' },
              { id: 'f18', front: 'What were "reparations"?', back: 'Compensation payments Germany had to pay.' },
              { id: 'f19', front: 'What is "War Guilt Clause"?', back: 'Article 231 - Germany accepted blame for WWI.' },
              { id: 'f20', front: 'Which empires collapsed after WWI?', back: 'Ottoman, Austro-Hungarian, Russian, German.' },
              { id: 'f21', front: 'Who was Kaiser Wilhelm II?', back: 'German Emperor - abdicated after WWI.' },
              { id: 'f22', front: 'What were U-boats?', back: 'German submarines (Unterseeboot).' },
              { id: 'f23', front: 'New weapons in WWI?', back: 'Tanks, poison gas, airplanes, machine guns.' },
              { id: 'f24', front: 'Why did Russia withdraw (1917)?', back: 'Russian Revolution - Bolsheviks seized power.' },
              { id: 'f25', front: 'Western Front was where?', back: 'Belgium and France - trench warfare.' },
              { id: 'f26', front: 'Eastern Front was where?', back: 'Germany vs Russia.' },
              { id: 'f27', front: 'Who proposed League of Nations?', back: 'US President Woodrow Wilson.' },
              { id: 'f28', front: 'What were Wilson\'s 14 Points?', back: 'Peace proposals including League of Nations.' },
              { id: 'f29', front: 'How many died in WWI?', back: 'Over 17 million (soldiers and civilians).' },
              { id: 'f30', front: 'WWI led to which future war?', back: 'World War II (harsh Treaty caused German resentment).' }
            ],
            mcqs: [
              ...
              { id: 'q6', question: 'M in M.A.I.N. stands for:', options: ['Money', 'Militarism', 'Monarchy', 'Movement'], correctIndex: 1, explanation: 'Arms race and military glorification.' },
              { id: 'q7', question: 'Triple Alliance included:', options: ['Britain, France, Russia', 'Germany, Austria, Italy', 'USA, UK, France', 'Russia, Germany, UK'], correctIndex: 1, explanation: 'Germany, Austria-Hungary, Italy.' },
              { id: 'q8', question: 'Triple Entente included:', options: ['Germany, Austria, Italy', 'Britain, France, Russia', 'USA, UK, France', 'Japan, Italy, Germany'], correctIndex: 1, explanation: 'Britain, France, Russia.' },
              { id: 'q9', question: 'Gavrilo Princip was from:', options: ['Austria', 'Serbia', 'Germany', 'Russia'], correctIndex: 1, explanation: 'Serbian nationalist who killed Franz Ferdinand.' },
              { id: 'q10', question: 'WWI ended on:', options: ['Nov 11, 1917', 'Nov 11, 1918', 'Jan 1, 1919', 'June 28, 1919'], correctIndex: 1, explanation: 'November 11, 1918 - Armistice Day.' },
              { id: 'q11', question: 'Lusitania was a:', options: ['Country', 'Ship', 'Weapon', 'Treaty'], correctIndex: 1, explanation: 'British ship sunk by German submarine.' },
              { id: 'q12', question: 'League of Nations was proposed by:', options: ['Churchill', 'Wilson', 'Lloyd George', 'Clemenceau'], correctIndex: 1, explanation: 'US President Woodrow Wilson.' },
              { id: 'q13', question: 'War Guilt Clause was Article:', options: ['14', '231', '370', '1'], correctIndex: 1, explanation: 'Germany accepted war blame.' },
              { id: 'q14', question: 'Trench warfare was on:', options: ['Eastern Front', 'Western Front', 'Southern Front', 'Northern Front'], correctIndex: 1, explanation: 'Belgium and France.' },
              { id: 'q15', question: 'U-boats were German:', options: ['Planes', 'Tanks', 'Submarines', 'Guns'], correctIndex: 2, explanation: 'Underwater boats.' },
              { id: 'q16', question: 'Russia withdrew due to:', options: ['Victory', 'Revolution', 'Alliance', 'Treaty'], correctIndex: 1, explanation: 'Russian Revolution of 1917.' },
              { id: 'q17', question: 'Kaiser Wilhelm II was of:', options: ['Britain', 'France', 'Germany', 'Russia'], correctIndex: 2, explanation: 'German Emperor.' },
              { id: 'q18', question: 'New weapon in WWI:', options: ['Sword', 'Tank', 'Horse', 'Bow'], correctIndex: 1, explanation: 'Tanks, poison gas, airplanes were new.' },
              { id: 'q19', question: 'WWI deaths were about:', options: ['1 million', '5 million', '17 million', '50 million'], correctIndex: 2, explanation: 'Over 17 million died.' },
              { id: 'q20', question: 'Pan-Slavism promoted:', options: ['German unity', 'Slavic unity', 'Italian unity', 'British unity'], correctIndex: 1, explanation: 'Unity of Slavic peoples.' },
              { id: 'q21', question: 'After WWI, these empires fell:', options: ['British, French', 'Ottoman, Austrian', 'American, Canadian', 'Spanish, Portuguese'], correctIndex: 1, explanation: 'Ottoman, Austro-Hungarian, Russian, German.' },
              { id: 'q22', question: 'Imperialism means:', options: ['Trade', 'Colony competition', 'Peace', 'Democracy'], correctIndex: 1, explanation: 'Competing for colonies.' },
              { id: 'q23', question: 'Reparations were:', options: ['Apologies', 'Payments', 'Territories', 'Soldiers'], correctIndex: 1, explanation: 'Compensation Germany had to pay.' },
              { id: 'q24', question: 'Eastern Front was Germany vs:', options: ['France', 'Britain', 'Russia', 'USA'], correctIndex: 2, explanation: 'Germany fought Russia in the east.' },
              { id: 'q25', question: 'Wilson\'s 14 Points were about:', options: ['War', 'Peace', 'Trade', 'Empire'], correctIndex: 1, explanation: 'Peace proposals.' },
              { id: 'q26', question: 'Armistice Day is:', options: ['Nov 11', 'Jan 26', 'Aug 15', 'Dec 25'], correctIndex: 0, explanation: 'WWI ended on November 11, 1918.' },
              { id: 'q27', question: 'Central Powers leader was:', options: ['Britain', 'France', 'Germany', 'Russia'], correctIndex: 2, explanation: 'Germany led Central Powers.' },
              { id: 'q28', question: 'Poison gas was first used by:', options: ['Britain', 'France', 'Germany', 'USA'], correctIndex: 2, explanation: 'Germans first used chlorine gas.' },
              { id: 'q29', question: 'Treaty of Versailles caused:', options: ['Peace', 'German resentment', 'Alliance', 'Trade'], correctIndex: 1, explanation: 'Seeds of WWII.' },
              { id: 'q30', question: 'WWI was called:', options: ['Great War', 'World War', 'European War', 'All of these'], correctIndex: 3, explanation: 'It had many names before WWII.' }
            ],
            reels: [
              ...
              { id: 'r9', title: 'Gavrilo Princip', content: 'Serbian nationalist.\nShot Archduke.\nStarted WWI!', color: getReelColor(8) },
              { id: 'r10', title: 'Franz Ferdinand', content: 'Austrian Archduke.\nHeir to throne.\nAssassinated.', color: getReelColor(9) },
              { id: 'r11', title: 'Triple Alliance', content: 'Germany\nAustria-Hungary\nItaly', color: getReelColor(0) },
              { id: 'r12', title: 'Triple Entente', content: 'Britain\nFrance\nRussia', color: getReelColor(1) },
              { id: 'r13', title: 'Powder Keg', content: 'Balkans.\nNationalist tensions.\nReady to explode!', color: getReelColor(2) },
              { id: 'r14', title: 'U-Boats', content: 'German submarines.\nSank ships.\nKilled civilians.', color: getReelColor(3) },
              { id: 'r15', title: 'Lusitania', content: 'British ship.\nSunk 1915.\nAmericans died.', color: getReelColor(4) },
              { id: 'r16', title: 'Russia Exits', content: '1917 Revolution.\nBolsheviks.\nSigned peace.', color: getReelColor(5) },
              { id: 'r17', title: 'Armistice Day', content: 'Nov 11, 1918.\nWar ends.\n11th hour, 11th day, 11th month.', color: getReelColor(6) },
              { id: 'r18', title: 'Wilson\'s 14 Points', content: 'Peace plan.\nSelf-determination.\nLeague of Nations.', color: getReelColor(7) },
              { id: 'r19', title: 'War Guilt', content: 'Article 231.\nGermany blamed.\nHad to pay.', color: getReelColor(8) },
              { id: 'r20', title: 'Reparations', content: 'Germany pays.\n132 billion marks.\nEconomy crushed.', color: getReelColor(9) },
              { id: 'r21', title: 'Empires Fall', content: 'Ottoman gone.\nAustrian gone.\nRussian gone.\nGerman gone.', color: getReelColor(0) },
              { id: 'r22', title: 'Kaiser Wilhelm', content: 'German Emperor.\nAbdicated.\nFled to Netherlands.', color: getReelColor(1) },
              { id: 'r23', title: 'Western Front', content: 'Belgium, France.\nTrenches.\nBloodbath.', color: getReelColor(2) },
              { id: 'r24', title: 'Eastern Front', content: 'Germany vs Russia.\nMore movement.\nRussia lost.', color: getReelColor(3) },
              { id: 'r25', title: 'Poison Gas', content: 'Chemical weapon.\nChlorine, Mustard.\nHorrible death.', color: getReelColor(4) },
              { id: 'r26', title: 'Tank', content: 'New weapon.\nBritish invention.\nBroke stalemate.', color: getReelColor(5) },
              { id: 'r27', title: 'Airplane', content: 'Air warfare.\nDogfights.\nBombing.', color: getReelColor(6) },
              { id: 'r28', title: 'League of Nations', content: 'Peace organization.\nWilson\'s idea.\nFailed later.', color: getReelColor(7) },
              { id: 'r29', title: 'Death Toll', content: '17 million dead.\nSoldiers + civilians.\n"War to end all wars."', color: getReelColor(8) },
              { id: 'r30', title: 'Seeds of WWII', content: 'Treaty too harsh.\nGerman anger.\nHitler rises.', color: getReelColor(9) }
            ]
          }
        ]
      },
